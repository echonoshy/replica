...
class ConversationStatus(Base):
    ...
    old_msg_start_time: Mapped[datetime | None] = mapped_column(
        DateTime(timezone=True), nullable=True
    )
    new_msg_start_time: Mapped[datetime | None] = mapped_column(
        DateTime(timezone=True), nullable=True
    )
    last_memcell_time: Mapped[datetime | None] = mapped_column(
        DateTime(timezone=True), nullable=True
    )
