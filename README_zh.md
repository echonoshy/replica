...
### 🔎 究极混合搜索 (Hybrid Search)

还在用老掉牙的单一向量搜索？那已经是上个版本的玩法了。Replica 装备了：

- **🧠 向量搜索** - pgvector 驱动的语义级心电感应
- **📖 全文搜索** - PostgreSQL 祖传的精准文本匹配
- **🧬 RRF 融合** - Reciprocal Rank Fusion（说人话就是"双剑合璧，取长补短"）
- **⏳ 时间衰减** - 越新的记忆越清晰（完美模拟人类大脑）
- **🔀 MMR 重排** - 拒绝复读机，保证回忆的多样性

### 🗜️ 自动上下文折叠 (Context Compression)

聊得太嗨，上下文快爆了？小场面。Replica 会自动：

- 📊 盯着 token 余额
- 🗜️ 触及红线时，优雅地压缩早期对话
- 🥬 保证最近的聊天记录永远新鲜脆爽
- 💎 在压缩前，绝不忘记榨干最后一点有价值的记忆

### 🎨 赏心悦目的 Web 控制台

一边和 AI 谈笑风生，一边看着记忆被实时编织：
...
| `http://localhost:8000/docs` | 📚 Swagger API 魔法书 |
| `http://localhost:8000/health` | ❤️ 生命体征检查 |
...
<p align="center">
  由一个厌倦了给 AI 重复解释同一件事的开发者爆肝制作 👾
</p>

<p align="center">
  <a href="https://github.com/echonoshy/replica">⭐ 如果觉得好玩，去 GitHub 给个 Star 吧！</a>
</p>
