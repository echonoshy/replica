...
export function createEvergreenMemory(userId: string, data: { content: string; category: string }) {
...
export function searchKnowledge(data: { user_id: string; query: string; top_k?: number; entry_type?: string }) {
...
export function getUserKnowledge(userId: string, limit = 50, offset = 0, entryType?: string) {
