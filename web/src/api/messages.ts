...
export function sendMessage(sessionId: string, role: string, content: string, messageType: string = "message") {
...
export function getMessages(sessionId: string, limit = 50, offset = 0, includeCompacted = false) {
