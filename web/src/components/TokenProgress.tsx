...
export default function TokenProgress({ current, hardThreshold }: TokenProgressProps) {
  ...
  return (
    <div className="flex items-center gap-3 py-3 w-full">
      <div className="flex-1 border-2 border-border shadow-[2px_2px_0px_0px_#111111] rounded-md overflow-hidden bg-white">
        <Progress value={percentage} className="h-3 rounded-none" indicatorClassName={cn(getProgressColor())} />
      </div>
